...
<footer class="max-w-4xl mx-auto text-center p-4">
	<img src="https://rshogan.imgix.net/personal/logos/rsh_logo_with_text_nobg.png?auto=compress,format&h=100&w=198" loading="lazy" height={100} width={198} class="mx-auto -mt-12 mb-24" alt="RobertsHogan Logo">
    <div class="flex flex-col justify-between mt-16">
        <span>Handcrafted by Robert.</span>
        <span class="inline-flex sm:ml-auto sm:mt-0 pt-4 justify-center sm:justify-start space-x-4">
            <a class=" hover:text-vivid-500" href="mailto:robert@robertshogan.com" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z">
                        </path>
                    </svg>
                </a>
                <a class=" hover:text-vivid-500" href="https://www.facebook.com/robertshogancom" target="_blank">
                ...
                <a class="hover:text-vivid-500" href="https://twitter.com/robert_s_hogan" target="_blank">
                        <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-6 h-6" viewBox="0 0 24 24">
                ...
                <!-- <a class="hover:text-vivid-500" href="https://www.instagram.com/jessica_hogan_ma/" target="_blank">
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-6 h-6" viewBox="0 0 24 24"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect>
                    <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01">
                        </path>
                    </svg>
                </a> -->

                <a href="https://www.linkedin.com/in/robert-s-hogan/" target="_blank" class="hover:text-vivid-500">
                ...
                <a class=" hover:text-vivid-500" href="https://github.com/robert-s-hogan" target="_blank">
                    <svg fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="0" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 640 640">
                ...
                <a class=" hover:text-vivid-500" href="https://www.upwork.com/freelancers/robertshogan" target="_blank">
