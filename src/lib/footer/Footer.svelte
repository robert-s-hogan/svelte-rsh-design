...
<footer class="max-w-4xl mx-auto text-center p-4">
    ...
    <div class="flex flex-col justify-between mt-16">
        ...
        <span class="inline-flex sm:ml-auto sm:mt-0 pt-4 justify-center sm:justify-start space-x-4">
            <a class=" hover:text-vivid-500" href="mailto:robert@robertshogan.com" target="_blank" aria-label="Mail Icon">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z">
                        </path>
                    </svg>
                </a>
                <a class=" hover:text-vivid-500" href="https://www.facebook.com/robertshogancom" target="_blank" aria-label="Facebook Icon">
                ...
                <a class=" hover:text-vivid-500" href="https://github.com/robert-s-hogan" target="_blank" aria-label="Github Icon">
