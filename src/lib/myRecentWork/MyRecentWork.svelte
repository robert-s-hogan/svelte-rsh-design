<section class="text-gray-600 body-font bg-white">
      ...
      <div class="flex flex-wrap -m-4">
        <div class="p-4 md:w-1/3">
          <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
            <img class="lg:h-64 md:h-36 w-full object-contain object-center" src="https://rshogan.imgix.net/projects/tailwindcss-cofee-shop/rsh_coffee_hero.png?auto=compress,format&w=400&h=256" height={256} width={400} alt="blog">
            <div class="p-6">
        ...
        <div class="p-4 md:w-1/3">
          <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
            <img class="lg:h-64 md:h-36 w-full object-cover object-center" src="https://rshogan.imgix.net/projects/svelte-tailwindcss-product-template/product_design.png?auto=compress,format&w=400&h=256" height={256} width={400} alt="blog">
            <div class="p-6">
        ...
        <div class="p-4 md:w-1/3">
          <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
            <img class="lg:h-64 md:h-36 w-full object-cover object-center" src="https://rshogan.imgix.net/projects/svelte-tailwindcss-deck-project/deck_design.png?auto=compress,format&w=400&h=256" height={256} width={400} alt="blog">
            <div class="p-6">
              ...
              <div class="flex items-center flex-wrap ">
                <!-- <a disabled href="#" class="text-indigo-500 inline-flex items-center md:mb-2 disabled lg:mb-0"> -->
                  <p class="italic text-xs">Coming Soon</p>
                  <!-- <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M5 12h14"></path>
                    <path d="M12 5l7 7-7 7"></path>
                  </svg> -->
  ...
  <!-- My Recent Work -->
<!-- <section class="max-full mx-auto text-center py-32 px-8 bg-gradient-to-r from-primary-500 to-primary-900">
	<h2 class="font-bold mb-4 text-white">My Recent Work</h2>
	...
	<div class="relative mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
		<div class="border-2 mt-8 shadow-lg group container  rounded-md bg-white max-w-sm flex justify-center items-center  mx-auto content-div">
			...
			<div class="absolute opacity-0 group-hover:opacity-100 ">
				<span class="text-3xl font-bold text-indigo-800 tracking-wider leading-relaxed font-sans">
					Local Coffee Shop
				</span>
				<div class="pt-8 text-center">
					<a
						href="https://rshcom-coffee-template.netlify.app/"
						aria-label="Coffee Shop Template"
					>
						<button class="text-center rounded-lg p-4 bg-primary-500  text-white font-bold text-lg">
							Visit Website
						</button>
					</a>
				</div>
